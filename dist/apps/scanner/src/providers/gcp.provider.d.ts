...
export declare class GcpProvider implements CloudProviderInterface {
    readonly provider: CloudProvider;
    private readonly logger;
    private getStorageClient;
    listResources(credentials: any): Promise<StorageResource[]>;
    private checkPublicAccessFromIam;
    ...
    refreshResource(credentials: any, bucketName: string): Promise<StorageResource | null>;
}
